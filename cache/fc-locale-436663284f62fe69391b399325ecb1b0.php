<?php return array (
  ...
  'user.role.sectionEditor' => 'دبیر مقاله',
  ...
  'admin.auth.defaultSourceDescription' => 'مشخص نمودن یک منبع احراز هویت پیش‌فرض جدای از OJS دارای مزیت‌های زیر است:	  <ul>		  <li>		  چنانچه کاربری بخواهد در این سایت با نام کاربری که در منبع احراز هویت خارجی  و نه در خود سیستم OJS وجود دارد ثبت‌نام کند، ثبت‌نام زمانی انجام خواهد شد که رمز عبور مناسب سیستم خارجی را وارد کند.		  </li>	  </ul>',
  ...
  'manager.setup.citations.enable' => 'فعال‌سازی دستیار نشانه‌گذاری ارجاعات',
  ...
  'about.aboutThisPublishingSystem' => 'درباره این سامانه انتشاراتی',
  ...
  'installer.additionalLocalesInstructions' => 'زبان‌های اضافی را که مایلید این سیستم پشتیبانی کند انتخاب کنید. این زبان‌ها در دسترس مجلات این سایت برای استفاده قرار خواهند گرفت. البته زبان‌های اضافی را در زمان‌های دیگر نیز می‌توانید از طریق صفحه مدیریت سایت نصب کنید.',
  ...
  'user.authorization.noContext' => 'هیچ مجله ای تعریف نشده است',
